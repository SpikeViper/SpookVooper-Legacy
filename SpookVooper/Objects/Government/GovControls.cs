...
namespace SpookVooper.Web.Government
{
    public class GovControls
    {
        ...
        /// <summary>
        /// Returns the single instance of the Government Controls
        /// </summary>
        public static async Task<GovControls> GetCurrentAsync(VooperContext context)
        {
            return await context.GovControls.FirstOrDefaultAsync();
        }
    }
}
